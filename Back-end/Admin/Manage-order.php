			...
			<?php
			 ...
			 ?>					
								<tr>
									...
									<td><a href="delete-order.php?view=delete_oder&id=<?php echo $row["order_id"] ?>">Xóa</a></td>
									<td><a href="update-order.php?view=update_order&id=<?php echo $row["order_id"]?>">Cập Nhật</a></td>
								</tr>
			<?php
							}
						}
