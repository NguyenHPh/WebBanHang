...
<body>
	<div class = "container-fluid">
	  <div class = "row header-row">
			 ...
			 <div class = "col-lg-2 col-sm-12 col-xs-12 col-md-12">
				  ...
				  <div class="dropdown">
				   ...
				   <?php
					...
					?>
				  	<a href = "User-login.php?view=login&theme=man"><span style = "color: white; font-size: 17px; vertical-align: -15px;">Đăng nhập/Đăng kí</span></a>
					<?php		
						  }
					?>
				</div>
		...
		?>		
			<li><a href = "list-in-man.php?view=list&id=<?php echo $row["id"]; ?>" style="color: black"><?php echo $row['name']; ?></a></li>
		...
		<?php
			$sql = "SELECT * FROM product WHERE type = 'man' AND isShow = 'checked' ";	
