	  ...
	  <div class = "row header-row">
			  ...
			  <div class = "col-lg-2 col-sm-12 col-xs-12 col-md-12">
				  ...
				  <div class="dropdown">
				   ...
				   <?php
					...
					?>
				  	<a href = "User-login.php?view=login&theme=list-man"><span style = "color: white; font-size: 17px; vertical-align: -15px;">Đăng nhập/Đăng kí</span></a>
					<?php		
						  }
					?>
				</div>
		...
		<div class = "row header-row2">
			...
			<ul>
				...
				<li><a style="text-decoration-line: underline; color: burlywood; cursor: pointer;" href = "dong-ho-nam.php">Đồng hồ nam</a></li>
		...
		<div class = "row" style="text-align: center;">
			<h2><strong>Đồng Hồ Nam</strong></h2>
		</div>
		...
		<?php
			...
			while($row = mysqli_fetch_assoc($result)){
				if($row["id"] == $_GET["id"]){
		?>		
			<li><a href = "list-in-man.php?view=listproduct&id=<?php echo $row["id"]; ?>" style="color: hotpink;"><?php echo $row['name']; ?></a></li>
		
			<?php
				}else{
			?>
			<li><a href = "list-in-man.php?view=listproduct&id=<?php echo $row["id"]; ?>" style="color: black;"><?php echo $row['name']; ?></a></li>
			<?php
				}
			}
			echo "</ul>";
			...
			<?php
				$id = $_GET["id"];
				$query = "SELECT * FROM product WHERE type = 'man' AND category_id = '$id' AND isShow = 'checked'";
