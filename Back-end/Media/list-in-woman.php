...
<body>
	<div class = "container-fluid">
	  <div class = "row header-row">
			  ...
			  <div class = "col-lg-2 col-sm-12 col-xs-12 col-md-12">
				  ...
				  <div class="dropdown">
				   ...
				   <?php
					...
					?>
				  	<a href = "User-login.php?view=login&theme=list-woman"><span style = "color: white; font-size: 17px; vertical-align: -15px;">Đăng nhập/Đăng kí</span></a>
					<?php		
						  }
					?>
				</div>
		...
		?>		
			<li><a href = "list-in-woman.php?view=listproduct&id=<?php echo $row["id"];?>".php?view=listproduct&id=<?php echo $row["id"]; ?>" style="color: black"><?php echo $row['name']; ?></a></li> 
<!--				view=listproduct&id khong duoc ghi cach ra vi do la URL neu cach ra se lam sai URL dan den GET khong lay duoc ket qua chinh xac-->
			...
			<?php
				...
				$query = "SELECT * FROM product WHERE type = 'woman' AND category_id = '$p_id' AND isShow = 'checked'";
